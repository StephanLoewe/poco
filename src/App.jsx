        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          {!authed && (
            <button onClick={onLogin} title="Mit Google anmelden"
              style={{ width: 34, height: 34, borderRadius: 10, border: "1px solid rgba(37,99,235,0.3)", background: "rgba(37,99,235,0.06)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
